...
class Model(nn.Module):
    def __init__(self, embed_dim, num_blocks, num_heads, ff_dim, dropout_rate, batch_size, vocab_size):
        ...
        self.positional_encoding = nn.Embedding(512, embed_dim) 
    ...
    def forward(self, sequence, key_padding_mask, causal_mask):
        ...
        sequence += self.positional_encoding(torch.arange(0, sequence.shape[1], dtype = torch.long, device = sequence.device).unsqueeze(0))                                              
